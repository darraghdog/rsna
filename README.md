...
| ---------------|----------|------|---|----|----|--------|------|---------------------------------|
| ResNeXt-101 32x8d (v12) with LSTM |480       |6, 5, 5     |9X |None|0 1 2   |0.05725 0.05880 0.05669 |0.057 | HFlip TTA all folds (0-hflip, 1 2 - transpose), Concat delta, bag9 epochs, `scripts/resnextv12/trainlstmdelta.py`  & `eda/val_lstm_v12.py` , bsize 4 patients | 
