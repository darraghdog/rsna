...
#         ylstmsub = magicF((sum(lstmlssub)/len(lstmlssub)), 1.).clip(0.00001, 0.99999)
#         ylstmval = magicF((sum(lstmlsval)/len(lstmlsval)), 1.).clip(0.00001, 0.99999)
...
ylstmsub.to_csv(os.path.join(results_path, './sub/submit_04_sub_lstmCNN_emb_resnext101v12_sz480_LU_2048.csv.gz'), \
            compression = 'gzip')
