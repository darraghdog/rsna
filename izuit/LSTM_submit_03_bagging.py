...
for LSTM_UNITS in ['512']:
    for FOLD,START,BAG in zip([0,1,2],[0,0,0], [7,5,5]):
        ...
        fname = '03_CNNlstm{}deep_{}_emb_sz480_fold{}_epoch{}.csv.gz'
...
#         ylstmsub = magicF((sum(lstmlssub)/len(lstmlssub)), 1.2).clip(0.00001, 0.99999)
#         ylstmval = magicF((sum(lstmlsval)/len(lstmlsval)), 1.2).clip(0.00001, 0.99999)
...
ylstmsub.to_csv(os.path.join(results_path, './sub/submit_03_sub_lstmCNN_emb_resnext101v12_sz480_LU_512.csv.gz'), \
            compression = 'gzip')
