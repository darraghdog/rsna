...
for LSTM_UNITS in ['512']:
    for FOLD,START,BAG in zip([0,1,2],[0,0,0], [7,5,5]):
        ...
        fname = 'CNNlstm{}deep_{}_emb_sz480_fold{}_epoch{}.csv.gz'
...
ylstmsub.to_csv(os.path.join(results_path, './sub/submit_02_sub_lstmCNN_emb_resnext101v12_sz480_LU_512.csv.gz'), \
            compression = 'gzip')
