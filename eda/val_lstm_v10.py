...
for LSTM_UNITS in ['1024']:
    for FOLD,START,BAG in zip([0],[0],[6]):
        #FOLD=1
        fnamels = ['seq/v12/lstm/lstm{}delta_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
        #fnamels = ['seq/v12/lstm/lstm{}deep_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
        lstmlssub = []
        lstmlsval = []
...
lstmlssub = []
#fname = 'seq/v12/lstm/lstm{}deep_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz'
fnamels = ['seq/v12/lstm/lstm{}delta_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
#fnamels += ['seq/v12/lstm/lstm{}slice_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
for LSTM_UNITS in ['1024']:
    for FOLD,START,BAG in zip([0],[0], [6]):
        for fname in fnamels:
            lstmlssub += [pd.read_csv(os.path.join(path_data, \
...
ylstmsub.to_csv(os.path.join(path, \
            '../sub/sub_lstmdelta_emb_resnext101v12_sz480_fold0_gepoch012345_LU_1024.csv.gz'), \
            compression = 'gzip')