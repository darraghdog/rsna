...
lstmlssub = []
fnamels = ['resnetv12/lstm{}{}delta_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
fnamels += ['resnetv13/lstm{}{}delta_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
for LSTM_UNITS in ['2048']:
    for FOLD,START,BAG,TTA in zip([0,1,2],[0]*3,[5,5,5],['T']*3):
...
ylstmsub.to_csv(os.path.join(path, 'submissionA.csv.gz'), compression = 'gzip')
