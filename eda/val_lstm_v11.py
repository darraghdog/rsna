...
for LSTM_UNITS in ['1024']:
    for FOLD,START,BAG,TTA in zip([0,1,2],[0]*3,[5]*4,['T', '', '']):
        fnamels = ['seq/v12/lstmv01/lstm{}{}delta_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
...
ylstmsub.to_csv(os.path.join(path, \
            '../sub/sub_lstmdelta_emb_resnext101v12_fold0tta_sz480_fold012_gepoch01234_LU_1024.csv.gz'), \
            compression = 'gzip')