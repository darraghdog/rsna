...
for LSTM_UNITS in ['1024']:
    for FOLD,START,BAG,TTA in zip([0,1,2],[0]*3,[6,5,5],['T', 'P', 'P']):
        fnamels = ['seq/v12/lstmv02/lstm{}{}delta_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
...
ylstmsub.to_csv(os.path.join(path, \
            '../sub/sub_lstmdelta_emb_resnext101v12_sz480_fold012tta_gepoch01234_LU_1024.csv.gz'), \
            compression = 'gzip')