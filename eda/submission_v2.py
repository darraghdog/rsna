...
for i in range(epochs):
    ...
    ypred = pd.read_csv(os.path.join(path, 'tst_pred_256_fold0_epoch{}_samp1.0.csv.gz'.format(i)))
...
ylb.to_csv(os.path.join(path, '../sub_pred_256_fold0_epoch{}_efficientnet.csv.gz'.format(i)), \
