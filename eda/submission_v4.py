...
for i in range(epochs):
    ...
    ypred = pd.read_csv(os.path.join(path, 'tst_pred_256_fold0_epoch{}.csv.gz'.format(i)))
...
ylb.to_csv(os.path.join(path, '../sub_pred_256_fold0_epoch{}_bag{}_Wtd_resnextv4.csv.gz'.format(i, bag)), \
