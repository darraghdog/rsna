...
for FOLD,START,BAG,fnamels in zip([0,1,2,0,1],
    ...
    '''
fnamev12 = ['seq/v12/stg2/lstmv10/lstmTP2048delta_epoch11_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
fnamev13 = ['seq/v13/stg2/lstmv10/lstmT2048delta_epoch11_{}_emb_sz256_wt256_fold{}_epoch{}.csv.gz']
...
'''
Fold 0 Epoch 5 Units 2048 bagged val logloss 0.05649
Fold 0 Epoch 5 Units 2048 bagged stg1 logloss 0.05752
Fold 1 Epoch 5 Units 2048 bagged val logloss 0.05797
Fold 1 Epoch 5 Units 2048 bagged stg1 logloss 0.05774
Fold 2 Epoch 5 Units 2048 bagged val logloss 0.05564
Fold 2 Epoch 5 Units 2048 bagged stg1 logloss 0.05784
Fold 2 Epoch 5 Units 2048 bagged stg1 bag logloss 0.05703
'''
...
ylstmtst2.to_csv(os.path.join(path, \
            '../sub/substg2_resnext101v12TP_v13T_fold012_gepoch01234_LU_2048.csv.gz'), \
            compression = 'gzip')
