...
for i in range(ep_from, ep_to):
    ...
    ypred = pd.read_csv(os.path.join(path, 'v8/tst_pred_sz384_wt384_fold5_epoch{}.csv.gz'.format(i)))
...
ylb.to_csv(os.path.join(path, '../sub_pred_sz384_fold5_bag{}_wtd_resnextv8.csv.gz'.format(i, bag)), \
