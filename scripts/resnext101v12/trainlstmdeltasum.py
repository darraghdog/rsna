...
for epoch in range(EPOCHS):
    ...
    if epoch==EPOCHS-1: yvalout.to_csv('lstmv07/lstm{}{}{}delta_val_{}.csv.gz'.format(TTAHFLIP, TTATRANSPOSE, LSTM_UNITS, embnm), \
    ...
    #        index = False, compression = 'gzip')
    if epoch==EPOCHS-1: ytstout.to_csv('lstmv07/lstm{}{}{}delta_sub_{}.csv.gz'.format(TTAHFLIP, TTATRANSPOSE, LSTM_UNITS, embnm), \
            index = False, compression = 'gzip')
