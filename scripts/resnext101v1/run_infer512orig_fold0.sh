...
bsub  -q lowpriority -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=darraghdog/kaggle:apex_build \
            ...
            --logmsg Rsna-leaderboard-$SIZE-fp16 --epochs 10 --fold $FOLD  --lr 0.00002 --batchsize 16  --workpath scripts/$WDIR  \
            --infer TST --imgpath data/mount/512X512X6/ --weightsname weights/model_512_resnext101$FOLD.bin"
