...
bsub  -q lowpriority -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=darraghdog/kaggle:rsna \
            ...
            --logmsg Rsna-lb-$SIZE-fp16 --epochs 1 --fold $FOLD  --lr 0.00002 --batchsize 32  --workpath scripts/$WDIR  \
            --infer VAL --imgpath data/mount/512X512X6/ --size $SIZE --weightsname weights/model_512_resnext101$FOLD.bin"
