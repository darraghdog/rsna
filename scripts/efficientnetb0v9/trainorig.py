...
parser.add_option('-k', '--randsample', action="store", dest="randsample", help="Random Sample Fraction of patients with no diagnosis", default="FALSE")
...
class IntracranialDataset(Dataset):
    ...
    def __getitem__(self, idx):
        imname1 = self.data.loc[idx, 'Image']
        imname0, imname2 = self.seq.loc[imname1]
